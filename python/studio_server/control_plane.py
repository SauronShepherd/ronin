...
class WorkflowReader(Protocol):
    ...
    def ingest_event(self, event: SchedulerEventRecord) -> object: ...
...
class CatalogReader(Protocol):
    def list_assets(self, workspace_id: WorkspaceId) -> object: ...
    ...
    def list_revisions(self, workspace_id: WorkspaceId, asset_id: AssetId) -> object: ...

    def get_revision(self, workspace_id: WorkspaceId, ref: AssetRef) -> object: ...

    def upstream(self, workspace_id: WorkspaceId, ref: AssetRef) -> object: ...

    def downstream(self, workspace_id: WorkspaceId, ref: AssetRef) -> object: ...

    def list_lineage(self, workspace_id: WorkspaceId, *, limit: int = 1000) -> object: ...
