...
| Workspace/project/source control | partial | workspace/project persistence, authenticated create/read/update/archive workspace and project lifecycles with idempotency, audit and active-project filtering, project manifest, reproducible secret-free deployment manifest with canonical identity, Git identity, environment/deployment bindings, and a Studio journey covering project creation, environment binding, Bundle export/archive and governed pipeline execution; project-scoped permission inspection, full Public v1 APIs/UI and membership remain |
