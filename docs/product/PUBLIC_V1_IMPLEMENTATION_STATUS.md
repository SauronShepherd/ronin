...
**Observed source head:** `ad93a1ac2f241c0b4c559723338d8261afc9f9af` (2026-09-24).
...
| Web Studio | partial | authenticated static Studio shell supports job/evidence/event workflows, project-scoped read-only SQL and a Monitoring & Alerts route; 75 Playwright route/accessibility/history/domain-journey checks pass; authoring editors, domain workflows and complete Public v1 journeys remain |
