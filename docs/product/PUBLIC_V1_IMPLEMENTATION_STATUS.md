...
**Observed source head:** `2fac2baa5cc49ea5c067c4f26f18fdb153014254` (2026-09-24).
...
| Web Studio | partial | authenticated static Studio shell supports job/evidence/event workflows, project-scoped read-only SQL and a Monitoring & Alerts route; 72 Playwright route/accessibility/history/domain-journey checks pass; authoring editors, domain workflows and complete Public v1 journeys remain |
